...
/* core */
// ensures updates roll even when .git/.svn folders are are found (even in plugins and folders above WP) 
add_filter( 'automatic_updates_is_vcs_checkout', '__return_false', 1 ); 

// do NOT allow core auto updates
//add_filter( 'auto_update_core', '__return_false' );

// allow only minor revisions and security patches 
add_filter( 'allow_minor_auto_core_updates', '__return_true' ); 

// allow major & minor revisions
